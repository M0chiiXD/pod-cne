...
function stepHit(curStep:Int) {
    if (curStep == 448) {
		strumLines.members[0].characters[0].visible = strumLines.members[0].visible = iconP2.visible = false;
    } else if (curStep == 576) {
		strumLines.members[0].visible = strumLines.members[0].characters[0].visible = iconP2.visible = true;
	} else if (curStep == 128) {
